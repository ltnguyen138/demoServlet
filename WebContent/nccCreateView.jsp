...
<div class="container">
          ...
          <li><a href="logout">Đăng xuất</a></li>  
        		...
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Them-moi-nha-cung-cap">
        				
          					<ul>                   
          						<li><p>Mã nhà cung cấp</p></li>
          						<li><input type="text" name="maNCC" value="${ncc.maNCC}"/> </li>                        
          						<li><p>Tên nhà cung cấp</p></li>
					          	<li><input type="text" name="tenNCC" value="${ncc.tenNCC}"/> </li>                          
					          	<li><p>Email nhà cung cấp</p></li>
