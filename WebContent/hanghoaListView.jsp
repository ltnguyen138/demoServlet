		...
		<div class="container">
  			...
  			<nav>
    			<div class="menu">
   				...
   				<div class="search">
   				<form method="GET" action="${pageContext.request.contextPath}/Danh-sach-hang-hoa">
          ...
          <li><a href="logout">Đăng xuất</a></li>  
        	...
        	<div class="list">            
				<div class="themmoi">
					<a  href="Them-moi-hang-hoa" >Thêm mới</a>
				</div>
				<table class="table">				
					<tr>
						<th>Mã hàng hóa</th>
					...
					<tr>
						...
						<td><a href="Cap-nhat-hang-hoa?MaHH=${hanghoa.maHH}">Sửa</a> </td>
