	...
	<body>
		<div class="container">
          ...
          <li><a href="logout"> Đăng xuất</a></li>  
        		...
        		<div class="tieude">
        			<h1>CẬP NHẬT THÔNG TIN CHI TIẾT PHIẾU NHẬP</h1>
        		</div>
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Cap-nhat-chi-tiet-phieu-nhap">
        				<input type="hidden" name="maphieunhap" value="${ctphieunhap.maphieu}">
        				<input type="hidden" name="mahanghoa" value="${ctphieunhap.mahanghoa}">
        				<input type="hidden" name="tenhanghoa" value="${ctphieunhap.tenhanghoa}">
          					<ul>
                    
          						<li><p style="color:red;">Mã phiếu nhập:   ${ctphieunhap.maphieu}</p></li>                         
          						<li><p style="color:red;">Mã hàng hóa:   ${ctphieunhap.mahanghoa}</p></li>
          						<li><p style="color:red;">Tên hàng hóa:   ${ctphieunhap.tenhanghoa}</p></li>                         
					          	<li><p>Số lượng</p></li>
					          	<li><input type="text" name="soluong" value="${ctphieunhap.soluong}"/> </li>      					                 
					          	<li><p>Đơn giá</p></li>
					          	<li><input type="text" name="dongia" value="${ctphieunhap.dongia}"/> </li >  
					        </ul>      
          					<ul style=" margin-top: 10px;">
						          ...
						          <a href="Them-moi-phieu-nhap?mpx=${maphieunhap}" >Quay lại</a>
						          </li>
          					</ul>                              		    
          				</form>
        			</div>    
