	...
	<body>
		<div class="container">
          ...
          <li><a href="logout"> Dang Xuat</a></li>  
        	...
        	<div class="list">            
				<div class="themmoi">
					<a  href="Them-moi-loai-hang-hoa" >Thêm mới</a>
				</div>
				<table class="table">				
					<tr>
					...
					<c:forEach items="${loaihhList}" var="loaihh" >
					<tr>
						<td>${loaihh.maLoaihh}</td>
						<td>${loaihh.tenLoaihh}</td>
						<td><a href="Cap-nhat-loai-hang-hoa?MaLoaihh=${loaihh.maLoaihh}">Sửa</a> </td>
						<td><a href="Xoa-loai-hang-hoa?MaLoaihh=${loaihh.maLoaihh}">Xóa</a> </td>
					</tr>                     
					</c:forEach>			
