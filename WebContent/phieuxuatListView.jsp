		...
		<div class="container">
  			...
  			<nav>
    			<div class="menu">
   				...
   				<div class="search">
      				<form method="GET" action="${pageContext.request.contextPath}/Danh-sach-phieu-xuat">
          ...
          <li><a href="logout">Đăng xuất</a></li>  
        	...
        	<div class="list">            
				<div class="themmoi">
					<a  href="Them-moi-phieu-xuat" >Thêm mới</a>
				</div>
				<table class="table">				
					<tr>
						<th>Mã phiếu xuất</th>
					...
					<c:forEach items="${phieuxuatList}" var="phieuxuatList" >
					<tr>
						<td>${phieuxuatList.maphieuxuat}</td>
						<td>${phieuxuatList.makh}</td>
						<td>${phieuxuatList.manv}</td>
						<td>${phieuxuatList.ngaylapphieu}</td>
						<td>${phieuxuatList.thanhtien}</td>
						
						<td><a href="Chi-tiet-phieu-xuat?mpx=${phieuxuatList.maphieuxuat}">Chi tiết</a> </td>
					</tr>                     
					</c:forEach>			
