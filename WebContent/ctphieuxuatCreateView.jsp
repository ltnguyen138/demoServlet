...
<div class="container">
          ...
          <li><a href="logout"> Đăng xuất</a></li>  
        		...
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Them-moi-chi-tiet-phieu-xuat">
        				<input type="hidden" name="maphieuxuat" value="${maphieuxuat}">
          					<ul>                   
          						<li><p style="color:red;">Mã phiếu xuất:   ${maphieuxuat}</p></li>                         
          						<li><p>Mã hàng hóa</p></li>
          						<li>
					          	<select name="mahanghoa" >
					          	<c:forEach var="listhanghoa" items="${listhanghoa}">
            						<option value="${listhanghoa.maHH}">${listhanghoa.maHH}| ${listhanghoa.tenHH}</option>
          						</c:forEach>
					          	</select>
				                 </li>      
					          	<li><p>Số lượng</p></li>
