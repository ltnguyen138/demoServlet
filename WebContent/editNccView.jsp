	...
	<body>
		<div class="container">
          ...
          <li><a href="logout">Đăng xuất</a></li>  
        		...
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Cap-nhat-nha-cung-cap">
        				<input type="hidden" name="maNCC" value="${ncc.maNCC}">
          					<ul>
                    
          						<li><p style="color:red;">Mã nhà cung cấp:   ${ncc.maNCC}</p></li>                         
          						<li><p>Tên nhà cung cấp </p></li>
					          	<li><input type="text" name="tenNCC" value="${ncc.tenNCC}"/> </li>                          
					          	<li><p>Email nhà cung cấpp</p></li>
					          	<li><input type="text" name="emailNCC" value="${ncc.emailNCC}"/> </li>      					                 
					          	<li><p>Địa chỉ nhà cung cấp</p></li>
					          	<li><input type="text" name="diaChiNCC" value="${ncc.diaChiNCC}"/> </li> 
					          	<li><p>Số điện thoại nhà cung cấp</p></li>
					          	<li><input type="text" name="sdtNCC" value="${ncc.sdtNCC}"/> </li>    
					        </ul>      
