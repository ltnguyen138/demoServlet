	...
	<body>
		<div class="container">
          ...
          <li><a href="logout"> Dang Xuat</a></li>  
        		...
        		<div class="tieude">
        			<h1>CẬP NHẬT THÔNG TIN LOẠI HÀNG HÓA</h1>
        		</div>
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Cap-nhat-loai-hang-hoa">
        				<input type="hidden" name="maLoaihh" value="${loaihh.maLoaihh}">
          					<ul>
                    
          						<li><p style="color:red;">Mã loại hàng hóa:   ${loaihh.maLoaihh}</p></li>                         
  		...
  		<footer>
    		<div class="fLeft">
	      		<p>Cua Hàng Vật Tư Nông Nghiệp</p>
