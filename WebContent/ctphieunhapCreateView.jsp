...
<div class="container">
          ...
          <li><a href="logout"> Đăng xuất</a></li>  
        		...
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Them-moi-chi-tiet-phieu-nhap">
        				<input type="hidden" name="maphieunhap" value="${maphieunhap}">
          					<ul>                   
          						<li><p style="color:red;">Mã phiếu nhập:   ${maphieunhap}</p></li>                         
          						<li><p>Mã hàng hóa</p></li>
					          	<li><input type="text" name="mahanghoa" /> </li>  
					          	<li><p>Tên hàng hóa</p></li>
					          	<li><input type="text" name="tenhanghoa" /> </li>                        
					          	<li><p>Số lượng</p></li>
					          	<li><input type="text" name="soluong" > </li>      					                 
					          	<li><p>Đơn giá</p></li>
					          	<li><input type="text" name="dongia" /> </li>  
					        </ul>      
          					<ul style=" margin-top: 10px;">
						          ...
						          <a href="Them-moi-phieu-nhap?mpn=${maphieunhap}" >Quay lại</a>
						          </li>
          					</ul>                              		    
          				</form>
        			</div>    
