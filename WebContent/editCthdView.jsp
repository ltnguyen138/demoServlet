	...
	<body>
		<div class="container">
          ...
          <li><a href="logout"> Dang Xuat</a></li>  
        		...
        		<div class="tieude">
        			<h1>CẬP NHẬT THÔNG TIN CHI TIẾT HÓA ĐƠN</h1>
        		</div>
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Cap-nhat-chi-tiet-hoa-don">
        				<input type="hidden" name="maHD" value="${cthd.maHD}">
          					<ul>
                    
          						<li><p style="color:red;">Mã hóa đơn:   ${cthd.maHD}</p></li>                         
          						<li><p>Mã hàng hóa</p></li>
					          	<li><input type="text" name="maHH" value="${cthd.maHH}"/> </li>                          
					          	<li><p>Số lượng</p></li>
					          	<li><input type="text" name="soLuong" value="${cthd.soLuong}"/> </li>      					                 
          					...
          					<ul style=" margin-top: 10px;">
						          ...
						          <a href="Danh-sach-chi-tiet-hoa-don" >Quay lại</a>
						          </li>
          					</ul>                              		    
          				</form>
        			</div>    
