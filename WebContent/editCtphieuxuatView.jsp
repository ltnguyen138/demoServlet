	...
	<body>
		<div class="container">
          ...
          <li><a href="logout"> Đăng xuất</a></li>  
        		...
        		<div class="tieude">
        			<h1>CẬP NHẬT THÔNG TIN CHI TIẾT PHIẾU XUẤT</h1>
        		</div>
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Cap-nhat-chi-tiet-phieu-xuat">
        				<input type="hidden" name="maphieuxuat" value="${ctphieuxuat.maphieuxuat}">
        				<input type="hidden" name="mahanghoa" value="${ctphieuxuat.mahanghoa}">
						<input type="hidden" name="dongia" value="${ctphieuxuat.dongia}">
          					<ul>
                    
          						<li><p style="color:red;">Mã phiếu nhập:   ${ctphieuxuat.maphieuxuat}</p></li>                         
          						<li><p style="color:red;">Mã hàng hóa:   ${ctphieuxuat.mahanghoa}</p></li>
                       
					          	<li><p>Số lượng</p></li>
					          	<li><input type="text" name="soluong"/> </li>      					                 
					          	<li><p style="color:red;">${errorsl}</p></li>  
          					...
          					<ul style=" margin-top: 10px;">
						          ...
						          <a href="Them-moi-phieu-xuat?mpx=${maphieuxuat}" >Quay lại</a>
						          </li>
          					</ul>                              		    
          				</form>
        			</div>    
