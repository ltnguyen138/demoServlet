...
<div class="container">
          ...
          <li><a href="logout">Đăng xuất</a></li>  
        		...
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Them-moi-khach-hang">
        				
          					<ul>                   
          						<li><p>Mã khách hàng</p></li>
          						<li><input type="text" name="maKH" value="${khachhang.maKH}"/> </li>                        
          					...
          					<ul style=" margin-top: 10px;">
						          ...
						          <a href="Danh-sach-khach-hang" >Quay lại</a>
						          </li>
          					</ul>                              		    
          				</form>
        			</div>    
