	...
	<body>
		<div class="container">
          ...
          <li><a href="logout">Đăng xuất</a></li>  
        		...
        		<div class="form">
        			<form method="POST" action="${pageContext.request.contextPath}/Cap-nhat-khach-hang">
        				<input type="hidden" name="maKH" value="${khachhang.maKH}">
          					<ul>
                    
          						<li><p style="color:red;">Mã khách hàng:   ${khachhang.maKH}</p></li>                         
          						<li><p>Tên khách hàng</p></li>
					          	<li><input type="text" name="tenKH" value="${khachhang.tenKH}"/>  </li>                          
					          	<li><p>Email khách hàng</p></li>
					          	<li><input type="text" name="emailKH" value="${khachhang.emailKH}"/> </li>      					                 
					          	<li><p>Sdt khách hàng</p></li>
					          	<li><input type="text" name="sdtKH" value="${khachhang.sdtKH}"/> </li>   
					        </ul>      
          					<ul style=" margin-top: 10px;">
						          ...
						          <a href="Danh-sach-khach-hang" >Quay lai</a>
						          </li>
          					</ul>                              		    
          				</form>
        			</div>    
