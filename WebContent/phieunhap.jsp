	...
	<body>
		<div class="container">
          ...
          <li><a href="Them-moi-khach-hang"> Đăng xuất</a></li>  
			...
			<form method="POST" action="${pageContext.request.contextPath}/Them-moi-phieu-nhap">
        	<div class="tieude">
        		<h1>THÊM MỚI PHIẾU NHẬP</h1>
        	</div>
            <div class="phieu">
				<div class="phieu1">
                	<p>Mã phiếu nhập: ${maphieunhap}</p>
                	<input type="hidden" name="maphieunhap" value="${maphieunhap}">
				</div>
				<div class="phieu1">
					<ul>
						<li><p>Mã nhà cung cấp:</p></li>
						<li><select name="mancc" >
					          	<c:forEach var="danhsachncc" items="${danhsachncc}">
            						<option value="${danhsachncc.maNCC}">${danhsachncc.maNCC}| ${danhsachncc.tenNCC}</option>
          						</c:forEach>
					          	</select></li>    
						</ul>
				</div>
        	...
        	<div class="list">            
				<div class="themmoi">
					<a  href="Them-moi-chi-tiet-phieu-nhap?mpn=${maphieunhap}" >Thêm mới</a>
				</div>
				<table class="table">				
					<tr>
					...
					<tr>
						...
						<td><a href="Cap-nhat-chi-tiet-phieu-nhap?mpn=${maphieunhap}&mhh=${ctphieunhapList.mahanghoa}">Sửa</a> </td>
						<td><a href="Xoa-chi-tiet-phieu-nhap?mpn=${maphieunhap}&mhh=${ctphieunhapList.mahanghoa}">Xóa</a> </td>
					</tr>                     
					</c:forEach>							
				</table>
			...
			<ul style="padding-left: 0%; margin-top: 10px;">
				...
				<a href="Danh-sach-nha-cung-cap" >Quay lai</a>
				 </li>
				</ul> 
			</div>	
		</form>   
